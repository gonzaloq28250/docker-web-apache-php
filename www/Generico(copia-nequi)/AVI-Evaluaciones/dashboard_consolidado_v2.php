...
if ($aplicarFiltros) {
    ...
    $paramsResultado = [':cliente' => $clienteActual];
        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex items-center gap-3">
                ...
                <div class="flex gap-2">
                    <a href="evaluacion_transcripciones.php" class="bg-indigo-500 hover:bg-indigo-400 text-white px-4 py-2 rounded-lg transition flex items-center gap-2 text-sm">
                        <i class="fas fa-clipboard-check"></i> Evaluar Transcripciones
                    </a>
                </div>
            </div>
        </div>
