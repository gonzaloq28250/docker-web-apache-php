...
$where = "e.cliente = :cliente AND e.fecha_evaluacion >= :desde AND e.fecha_evaluacion < DATE_ADD(:hasta, INTERVAL 1 DAY)";
...
if ($esEleven) {
    $stmt = $pdo->prepare("
        ...
        LEFT JOIN eleven_n8n_t1 ent ON acc.conversation_id = ent.ElevenConversationID
