...
$tasaRetencionAVIHoy = $totalLlamadasAVIHoy > 0 ? (($retencionExitosaHoy + $consultaResueltaHoy) / $totalLlamadasAVIHoy) * 100 : 0;
...
if ($aplicarFiltros) {
    ...
    $tasaRetencionAVIHistorico = $totalLlamadasAVIHistorico > 0 ? (($retencionExitosaHistorico + $consultaResueltaHistorico) / $totalLlamadasAVIHistorico) * 100 : 0;
